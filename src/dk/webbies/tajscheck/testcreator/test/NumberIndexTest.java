 ...
 */
public class NumberIndexTest extends Test {
    private final Type obj;
    private final Type returnType;

    public NumberIndexTest(Type obj, Type returnType, String path, TypeContext typeContext) {
        super(Collections.singletonList(obj), Collections.emptyList(), returnType, path + ".[numberIndexer]", typeContext);
        this.obj = obj;
