...
(function() {
  ...
  defineInstance(sugarDate, {
     ...
     *   new Date().medium('ja') -> ex. 2016?2?13?
     *
     * @param {string} [localeCode]
     *
     ***
  ...
  function getSortOrder() {
    var order = 'AÁÀÂÃABCCCÇDDÐEÉÈEÊËEFGGHiIÍÌIÎÏJKLLMNNNÑOÓÒÔPQRRSSŠSTTUÚÙUÛÜVWXYÝZZZŽÞÆŒØÕÅÄÖ';
  ...
  function getSortEquivalents() {
    var equivalents = {};
    forEach(spaceSplit('AÁÀÂÃÄ CÇ EÉÈÊË IÍÌIÎÏ OÓÒÔÕÖ Sß UÚÙÛÜ'), function(set) {
  ...
  var BASIC_UNITS         = '|kmbt',
      ...
      METRIC_UNITS_SHORT  = 'nµm|k',
      METRIC_UNITS_FULL   = 'yzafpnµm|KMGTPEZY';
  ...
  defineInstance(sugarNumber, {
    ...
    /***
     * @method metric([precision] = 0, [units] = "nµm|k")
     * @returns String
